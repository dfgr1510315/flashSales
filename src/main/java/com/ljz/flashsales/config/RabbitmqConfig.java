...
public class RabbitmqConfig {
    ...
    public Queue successEmailQueue(){
        return new Queue(Objects.requireNonNull(env.getProperty("mq.kill.item.success.email.queue")),true);
    }
    ...
    public Queue successKillDeadQueue(){
        ...
        return new Queue(Objects.requireNonNull(env.getProperty("mq.kill.item.success.kill.dead.queue")),true,false,false,argsMap);
    }
